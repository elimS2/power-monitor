...
| month_load_kwh | 66 | unsigned | ×0.1 | Споживання за місяць (1PH; 3PH може відрізнятися) |
| year_load_kwh | 87-88 | 32-bit | ×0.1 | Споживання за рік (тільки 1PH, 3PH може не підтримувати) |
