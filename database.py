...
def deye_cumulative_metrics(last: dict | None) -> list[dict]:
    ...
    rows = [
        ...
        ("Рік", "87–88", "За поточний рік (×0.0001 для 3PH)", "year_load_kwh", deye_yearly_load_kwh),
        ("Всього", "527–528", "За весь час (×0.0001 для 3PH)", "total_load_kwh", deye_total_load_kwh_integrated),
    ]
    result = []
